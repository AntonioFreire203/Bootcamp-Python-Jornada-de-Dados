...
Exercício será tipar o desafio da aula 
...
### 2. Listas ,Tuplas,Dicionários
Python (com lista = [1, 2, 3]): Em Python, quando você cria uma lista como lista = [1, 2, 3], o Python não reserva um tamanho fixo de memória de antemão. O tamanho da lista em Python é dinâmico, o que significa que você pode adicionar ou remover elementos conforme necessário, sem se preocupar com o tamanho inicial.
...
### Dicionários (dict)
   ...
   * Definição: Os dicionários representam coleções de dados que contém na sua estrutura um conjunto de pares chave/valor, nos quais cada chave individual tem um valor associado. Esse objeto representa a ideia de um mapa, que entendemos como uma coleção associativa desordenada
...
### Exercícios Easy de Listas e Dicionários
